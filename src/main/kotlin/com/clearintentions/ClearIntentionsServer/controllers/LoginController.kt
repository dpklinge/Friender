package com.clearintentions.ClearIntentionsServer.controllers
...
import com.clearintentions.ClearIntentionsServer.services.LoginService
...
class LoginController(val loginService: LoginService) {
    ...
    suspend fun loginUser(@RequestBody loginPacket: LoginPacket)=
        loginService.verifyLoginInfo(loginPacket.username, Password(loginPacket.password))
